  ...
  return (
    <Content>
      <ScrollView>
        ...
        <Container>
          <ViewMap>
            <ImgMap source={require('@/assets/images/minimap.jpg')} />
            <ViewValor>
              <LabelCinza variant="labelLarge">Entregar em </LabelCinza>
              <LabelPreta variant="titleMedium">
                Rua dos engenheiros, 1047
              </LabelPreta>
          ...
          <LabelCinza variant="labelLarge" style={{ marginBottom: 16 }}>
            Portão da casa/prédio - portaria{' '}
          </LabelCinza>
          ...
          <DeliveryInfo>
            ...
            <ViewMap style={{ backgroundColor: '#F3F3F3' }}>
              ...
              <ViewValor>
                ...
                <TextValor variant="labelLarge">
                  Valor com entrega: 17,87
                </TextValor>
              </ViewValor>
            </ViewMap>
          </DeliveryInfo>
